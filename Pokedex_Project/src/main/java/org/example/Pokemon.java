...
public class Pokemon {
    ...
    public Pokemon(Pokemon poke) {
        ...
        this.base_experience= poke.getBase_experience();
        this.height=poke.getHeight();
        this.is_default=poke.getIs_default();
        this.order=poke.getOrder();
        this.weight=poke.getWeight();
        this.pokemonStats=poke.getPokemonStats();
        this.lstPokemonType=poke.getLstPokemonType();
        this.lstPokemonAbility=poke.getLstPokemonAbility();
        this.lstPokemonMove=poke.getLstPokemonMove();
        this.lstPokemonImage=poke.getLstPokemonImage();
